...
export const UserInfo = ({ currentUser }) => {
  ...
  return (
    <Styled.UserInfoWrap>
      ...
      <Styled.FlexBox>
        <Text>이메일</Text>
        <Styled.CurrentUserInfo>{currentUser?.email}</Styled.CurrentUserInfo>
      </Styled.FlexBox>
      <Styled.FlexBox>
        <Text>닉네임</Text>
        <Styled.CurrentUserInfo>{currentUser?.displayName}</Styled.CurrentUserInfo>
      </Styled.FlexBox>
    </Styled.UserInfoWrap>
  );
};
